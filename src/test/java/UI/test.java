    ...
    //@org.testng.annotations.Test
           // public static void main(String[] args) {
            ...
            //public void test2() {
               ...
               // driver.findElement(By.xpath("//*[@id=\"acf-driver-form\"]/div[2]/div[6]/div[2]/div/div[1]/div[1]/label")).click();
               // driver.manage().window().maximize();
                //driver.manage().timeouts().implicitlyWait(10, TimeUnit.MILLISECONDS);

                //Timeouts.implicitlyWait(10, TimeUnit.MILLISECONDS);
               // driver.findElement(By.xpath("/html/body/div[1]/main/div[1]/div/form/div[2]/div[6]/div[2]/div/div[1]/div[2]/div/input")).click();


                //driver.get("https://beta.ustruckingservice.com/apply-as-driver-new/");

                //WebElement mainTitle = (WebElement) By.xpath("/html/body/div[1]/main/div[1]/div/form/div[2]/div[6]/div[2]/div/div[1]/div[2]/div/input");
                // Assert.assertEquals(mainTitle.getText(),title);
                //Timeouts.implicitlyWait(10, TimeUnit.MILLISECONDS);
                //driver.findElement(By.xpath("")).sendKeys(Keys.ENTER);

                //Timeouts.implicitlyWait(10, TimeUnit.SECONDS);
                //driver.findElement(By.xpath("//*[@id=\"acf-driver-form\"]/div[2]/div[6]/div[2]/div/div[1]/div[2]/div")).click();


                // WebElement inputField = driver.findElement(By.xpath("/html/body/div[1]/main/div[1]/div/form/div[2]/div[6]/div[2]/div/div[1]/div[2]/div/input"));
                //class InputNumbersExample {
                    //public static void main(String[] args) {

                        //System.setProperty("webdriver.chrome.driver", "C:\\Users\\nvatsyk\\IdeaProjects\\Project2\\chromedriver-win64\\chromedriver.exe");
                       // WebDriver driver = new ChromeDriver();
                       // driver.get("https://beta.ustruckingservice.com/home-page-new/");
                        //WebElement inputField = driver.findElement(By.id("input_field_id"));
            ...
            public test3(String[] args) {
                ...
                class InputNumbers {
                    public void test4(String[] args) {
                        ...
                        driver.findElement(By.xpath("/html/body/div[1]/main/div[1]/div/form/div[2]/div[6]/div[2]/div/div[1]/div[2]/div/input")).isSelected();
                        inputField.sendKeys("12");
                        //WebElement inputField = driver.findElement(By.id("//*[@id=\"acf-field_63efde56eb46d-field_63efde67eb46e\"]"));
